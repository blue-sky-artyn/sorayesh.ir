...
public partial class Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        mainPicHtml.InnerHtml = "<img src='" + productTbl[0].productCoverPicAdd + productTbl[0].productCoverPicName + "' alt='"+ productTbl[0].productName + "' class='img-responsive'>" +
                                //"<div class='magnifier'><a rel='prettyPhoto[inline]' href='" + productTbl[0].productCoverPicAdd + "' title='" + productTbl[0].productName + "'>" +
                                //"<i class='flaticon-add'></i></a></div>" +
                                "";
        ...
        {
            if (counter == 3)
                productStr += "</div><div class='sub-pic-row  row'>";
            ...
            productStr += "<div class='col-md-4 col-sm-4 col-xs-4'><div class='image-wrap entry'>" +
                                ...
                                //"<div class='magnifier'><a rel='prettyPhoto[inline]' href='upload/single_shop_02.jpg' title=''>" +
                                //"<i class='flaticon-add'></i></a></div>" +
                                "</div></div>";
            counter++;
        }
